...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SuplementoRegimen.porcentaje'
        db.delete_column('motor_suplementoregimen', 'porcentaje')
    
    
    def backwards(self, orm):
        
        # Adding field 'SuplementoRegimen.porcentaje'
        db.add_column('motor_suplementoregimen', 'porcentaje', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=2), keep_default=False)
