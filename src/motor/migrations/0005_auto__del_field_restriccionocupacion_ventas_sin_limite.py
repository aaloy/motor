...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RestriccionOcupacion.ventas_sin_limite'
        db.delete_column('motor_restriccionocupacion', 'ventas_sin_limite')
    
    
    def backwards(self, orm):
        
        # Adding field 'RestriccionOcupacion.ventas_sin_limite'
        db.add_column('motor_restriccionocupacion', 'ventas_sin_limite', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)
