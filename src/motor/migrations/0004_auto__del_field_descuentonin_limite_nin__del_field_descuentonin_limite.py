...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DescuentoNin.limite_nin'
        db.delete_column('motor_descuentonin', 'limite_nin')

        # Deleting field 'DescuentoNin.limite_bebe'
        db.delete_column('motor_descuentonin', 'limite_bebe')
    
    
    def backwards(self, orm):
        
        # Adding field 'DescuentoNin.limite_nin'
        db.add_column('motor_descuentonin', 'limite_nin', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=12), keep_default=False)

        # Adding field 'DescuentoNin.limite_bebe'
        db.add_column('motor_descuentonin', 'limite_bebe', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2), keep_default=False)
