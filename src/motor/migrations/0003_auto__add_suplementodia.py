...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SuplementoDia'
        db.create_table('motor_suplementodia', (
            ('fecha', self.gf('django.db.models.fields.DateField')()),
            ('precio', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('aplicabilidad', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.send_create_signal('motor', ['SuplementoDia'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'SuplementoDia'
        db.delete_table('motor_suplementodia')
